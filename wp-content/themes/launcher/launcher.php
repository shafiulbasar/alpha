...
<?php get_header(); ?>  
	...
	<aside id="fh5co-aside" role="sidebar" class="text-center home-bg-image">
		<h1 id="fh5co-logo">
            <a class="text-info" href="<?php echo site_url(); ?>">
                <?php bloginfo("name"); ?>
            </a>
        </h1>
	</aside>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="row">
							...
							<?php 
                            $placeholder_id = get_post_meta(get_the_ID(),"placeholder",true);
							...
							<div class="col-lg-7 animate-box">
								<form action="#" id="fh5co-subscribe">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="<?php echo esc_attr($placeholder_id); ?>">
