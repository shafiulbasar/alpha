...
class QL_Widget
{
    ...
    public function add_dashboard_widget()
    {
        wp_add_dashboard_widget(
            ...
            __('QuadLayers News', 'insta-gallery'),
...
?>
        <div>
            <div>
                <div style="margin-top: 11px;float: left;width: 70%;">
                    <?php esc_html_e('Hi! We are Quadlayers! Welcome to QuadLayers! We’re a team of international people who have been working in the WordPress sphere for the last ten years.', 'insta-gallery'); ?>
                    <div style="margin-top: 11px; float: left; width: 70%;"><a href="<?php echo admin_url('admin.php?page=' . QLIGG_DOMAIN . '_suggestions'); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('More products', 'insta-gallery'); ?></a></div>
                </div>
                <img style="width: 30%;margin-top: 11px;float: right; max-width: 95px;" src="<?php echo plugins_url('/assets/backend/img/quadlayers.jpg', QLIGG_PLUGIN_FILE); ?>" />
            </div>
        ...
        <div style="display: flex; justify-content: space-between;align-items: center;margin: 16px -12px 0;padding: 12px 12px 0; border-top: 1px solid #eee;">
            <a href="<?php printf('https://quadlayers.com/blog/?utm_source=%s&utm_medium=software&utm_campaign=wordpress&utm_content=dashboard', QLIGG_DOMAIN); ?>" target="_blank"><?php esc_html_e('Read more like this on our blog', 'insta-gallery') ?></a>
            <a class="button-primary" href="<?php printf('https://quadlayers.com/?utm_source=%s&utm_medium=software&utm_campaign=wordpress&utm_content=dashboard', QLIGG_DOMAIN); ?>" target="_blank"><?php esc_html_e('QuadLayers', 'insta-gallery') ?></a>
        </div>
<?php
    }
